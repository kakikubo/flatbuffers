...
def analyzeDict(key, data):
	...
	for dataKey in dataKeys:
		...
		if isinstance(dataData, dict):
			...
			tableDict[dataKey] = ["dict", dataKey, dataKey]
		elif isinstance(dataData, list):
			analyzeList(dataKey, dataData)
			tableDict[dataKey] = ["list", dataKey, dataKey]
...
# root function
#
def json2fsb(jsonFile, rootName, nameSpace):
...
if __name__ == "__main__":
	...
	if argc < 3:
		...
		json2fsb(argv[1],argv[2],"")
	else:
		json2fsb(argv[1],argv[2],argv[3])
