...
if __name__ == '__main__':
    ...
    example:
    $ ./manifest_customize.py ""master 201504010000"" asset_USER_NAME/bundled/preload/ asset_USER_NAME asset/bundled/manifest/project.manifest asset_USER_NAME/bundled/manifest/project.manifest asset_USER_NAME/bundled/manifest/version.manifest""")
