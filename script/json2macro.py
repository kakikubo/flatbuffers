...
class Json2Macro():
    ...
    def generate_macro(self, data):
        ...
        for sheet in data:
            ...
            s += macro+"("+self.upper_camel_case(sheet['name'])+', '+sheet['name']+")\n"

        return s

    def generate(self, input_json, output_h, key):
        with open(input_json, 'r') as f:
            data = json.load(f, object_pairs_hook=OrderedDict)
            s = self.generate_macro(data[key])
...
if __name__ == '__main__':
    ...
    json2macro = Json2Macro()
    json2macro.generate(args.input_json, args.output_h, args.key)
    exit(0)
